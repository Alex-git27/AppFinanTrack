...
namespace ManejoPresupuestos.Controllers
{
   //Controlador de cuentas 
    public class CuentasController: Controller
    {
        ...
        //MOSTRAR DETALLES DE LAS CUENTAS A USUARIOS

        public async Task<IActionResult> Detalle(int id, int mes, int año) //PERMITIMOS VISUALIZAR LOS MOVIMIENTOS DE LAS CUENTAS POR MES
        {
            var usuarioId = servicioUsuarios.ObtenerUsuarioId();
            ...
            ViewBag.Cuenta = cuenta.Nombre; //DECLARAMOS EL NOMBRE DE LA CUENTA PARA QUE SE VISUALICE COMO TITULO/VARIABLE
